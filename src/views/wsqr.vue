<template>
  ...
  <el-row>
    <el-table :data="jsData" border stripe>  
      ...
      <el-table-column label="织长"></el-table-column>
      <el-table-column label="织缩率"></el-table-column>
      <el-table-column label="纬纱"></el-table-column>
      ...
      <el-table-column label="参考百米用纬"></el-table-column>
